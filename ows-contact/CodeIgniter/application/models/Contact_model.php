...
class Contact_model extends CI_Model
{
	...
	{
		$query = $this->db->get('contacts', 20); // lay 20 ban ghi dau tien trong bang contacts
		return $query->result();
	}
	...
	public function addContact($data = array()) // them
	{
